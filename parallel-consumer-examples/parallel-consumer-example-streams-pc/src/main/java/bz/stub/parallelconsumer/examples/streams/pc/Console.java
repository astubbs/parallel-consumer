...
final class Console {
    ...
    /**
     * {@code Locale.ROOT}, not the default locale. Required by {@code forbiddenapis}, which this module gets
     * the same as every other, and correct on its own terms: the report is a fixed-width table of grouped
     * numbers, and a locale that groups differently - or uses a comma for the decimal point - would
     * misalign the columns the reader compares down.
     */
