...
(That method is in `PartitionState.java`, which left astubbs#57 for astubbs#337 on 2026-08-24 - so a
reader chasing this into astubbs#57's diff will not find it there.)
