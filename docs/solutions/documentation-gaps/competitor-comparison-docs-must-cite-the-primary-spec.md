...
- `docs/inflight/release-0600-blockers.md` (folded into `docs/inflight/release-v6-scope.md` on 2026-09-08, itself retired at the 0.6.0.0 tag - `git show e6a429d87:docs/inflight/release-v6-scope.md`; the cited version is `git show 2c874ecac:docs/inflight/release-0600-blockers.md`) -- the sibling concern for version claims: "are the things
