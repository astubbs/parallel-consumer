...
> Extracted from `origin/docs/ks-streams-correct-commit-coverage-claims` @2a9119daf, `docs/solutions/architecture-patterns/a-query-must-never-mutate-derive-thread-safety-from-callers.md`.
