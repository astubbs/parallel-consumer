...
tags:
  ...
  - wake-on-work
  - kafka-streams
status: "In flight as of 2026-08-11. PR astubbs/parallel-consumer#271 and issue astubbs/parallel-consumer#255 are both open, nothing merged. PR #271 carries the dispatch seam only; the wake-on-work fix is on branch feats/ks-streams-wake-on-work and the benchmark on branch test/ks-streams-realistic-domain-benchmark, neither of which has a PR of its own yet."
related_prs:
