...
> Extracted from `origin/perf/192-offset-encoding-density` @2a31b0a74, `docs/solutions/best-practices/sneaky-thrown-checked-exceptions-defeat-spotbugs-dataflow.md`.
...
choke-point commit (session history). Notably, astubbs#207's first cut of that handler also mishandled a failure by treating it
