...
- The claim under assessment - *"Integration's red is the known flake (`PartitionStateCommittedOffsetIT`,
  already in inflight, fails on GitHub too) - not highcpu runner"* - is **true about highcpu runner** (reproduced locally;
...
- What **is** firmly established: it is a real stall (0 polls / 120s), not highcpu runner-specific, not a benign
