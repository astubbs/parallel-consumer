...
- **Open blockers:** None. The module shape was the last one and is settled (KD14); every other open item is deferred to planning, named in Outstanding Questions.
...
- None. The module shape, the last blocker, was settled on 2026-09-12 by extracting the substrate as its own module (KD14).
