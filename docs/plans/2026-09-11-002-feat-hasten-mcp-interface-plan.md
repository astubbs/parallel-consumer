...
- **Confirm the module shape against astubbs#514** (KD14), which carries the substrate module off master. It is a confirmation against a reviewable artifact, not an open design question, and it closes when that PR lands.
