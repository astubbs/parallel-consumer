...
<!-- post-merge: checked-begin - a dated sighting against a PR number, past tense, stays true after the merge -->
**Eighth sighting, 2026-09-05, on astubbs/parallel-consumer#452's Integration Tests lane**
...
`awaitPausePoint(...)` at `RegistrationRaceStaleResidentIT.java:221` - after 30.94s against the 30s
guard, 1 failure in 201 integration tests, the ambient probe clean (no rebalance dwell, no lag
