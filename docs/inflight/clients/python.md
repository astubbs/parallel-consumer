# Client: Python (astubbs#242)

Per-language working note for the Python client of the language-proxy plan
(`docs/plans/2026-08-14-001-feat-language-proxy-plan.md`). Effort figures, divergence notes, and
anything the Python wave learns that a later session needs go HERE - never appended to
...
`parallel-consumer-proxy-clients/parallel-consumer-proxy-client-python/`; its maturity and testing-evidence deferrals live in
