...
| The roadmap | Which themes this release advanced (`next-living-roadmap.md`) |
| Maturity table | Any module whose status changed (`next-module-maturity-table.md`) |
...
The index directory exists, the docs site consumes it, and the PR gate requires it.
