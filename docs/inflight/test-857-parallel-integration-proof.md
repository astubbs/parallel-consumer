# Gated on astubbs#29: proving thread-parallel integration tests are safe again <!-- post-merge: checked -->

<!-- inflight-type: task -->
<!-- inflight-impact: test-debt -->
<!-- inflight-state: deferred - cannot start until astubbs#29 lands --> <!-- post-merge: checked -->
