...
| astubbs#175 | **Credits the wrong PR** for the reporter's failure. Treats confluentinc#818 and confluentinc#819 as upstream-only when this tree carries both. Omits the close-path failure entirely | [`upstream-175-sporadic-commit-timeouts.md`](upstream-175-sporadic-commit-timeouts.md) - posted 2026-09-18 |
