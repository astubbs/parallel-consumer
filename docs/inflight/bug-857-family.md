...
## Deleting the split-out sightings files
...
2026-08-26 section asks for - replay one with astubbs#29's `tryLock()` applied and read whether the <!-- post-merge: checked -->
