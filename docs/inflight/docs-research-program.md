...
the credibility mechanism [`next-reclaim-the-category.md`][next-reclaim-the-category] says the
...
2. **How badly do real key distributions punish partition-serial execution?** The Zipf/hot-key
   ...
   [`next-the-tail-experiment.md`][next-the-tail-experiment] and the tailed work model
...
[`next-benchmark-a-model-of-work-not-work.md`][next-benchmark-a-model-of-work-not-work] and the
...
[next-benchmark-a-model-of-work-not-work]: https://github.com/astubbs/parallel-consumer/blob/cd2156ce9/docs/inflight/next-benchmark-a-model-of-work-not-work.md
[next-the-tail-experiment]: https://github.com/astubbs/parallel-consumer/blob/cd2156ce9/docs/inflight/next-the-tail-experiment.md
