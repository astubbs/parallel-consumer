...
| `maven.yml` | The main build: unit, integration and performance suites, static analysis (Infer and SpotBugs, batched as `static: analysis`), duplicate detection, PIT, dependency scanning. |
