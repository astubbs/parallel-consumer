...
If you have questions or find a bug, raise an https://github.com/astubbs/parallel-consumer/issues[issue] on GitHub.
...
NOTE: This is a community-maintained fork of https://github.com/confluentinc/parallel-consumer[confluentinc/parallel-consumer], published under different Maven coordinates. The original upstream project is no longer actively maintained.
