...
the release checks the stable modules' known critical failure modes, while their public APIs remain pre-1.0. An
...
| `parallel-consumer-core`
| Stable
| Release-gated for known critical failure modes
