...
Ordering is the exception among the per-route settings: it needs a change at the engine's shard-key seam, so in this release it is accepted as the instance default and nothing else.
