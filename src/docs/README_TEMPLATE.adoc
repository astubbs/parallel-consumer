...
This project publishes to Maven Central under the group ID `bz.stub.parallelconsumer`: https://central.sonatype.com/namespace/bz.stub.parallelconsumer[browse it on Maven Central].
