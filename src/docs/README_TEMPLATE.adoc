...
[source,java,indent=0]
----
include::{project_root}/parallel-consumer-examples/parallel-consumer-example-dashboard/src/main/java/io/confluent/parallelconsumer/examples/dashboard/DashboardApp.java[tag=example]
----
...
[source,java,indent=0]
----
include::{project_root}/parallel-consumer-examples/parallel-consumer-example-dashboard/src/main/java/io/confluent/parallelconsumer/examples/dashboard/DashboardApp.java[tag=exampleBind]
----
...
See the link:{project_root}/parallel-consumer-examples/parallel-consumer-example-dashboard/src/main/java/io/confluent/parallelconsumer/examples/dashboard/DashboardApp.java[dashboard example] project.
