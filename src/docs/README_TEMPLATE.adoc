...
The Maven `groupId` becomes `bz.stub`, and the Java packages move with it.
...
The library's shared internal utilities moved with it, into `bz.stub.parallelconsumer.internal.utils` -- they were always plumbing, and they are now named as such.
