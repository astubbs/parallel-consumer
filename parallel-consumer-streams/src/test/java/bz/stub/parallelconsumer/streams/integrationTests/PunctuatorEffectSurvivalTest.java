                ...
                .process((ProcessorSupplier<String, String, String, String>) () ->
                        new Processor<String, String, String, String>() {
                            ...
                            public void init(final ProcessorContext<String, String> context) {
                                ...
                                // patched file, so the punctuation itself never enters PC dispatch and
                                // what is measured is purely the effect path. Its REGISTRATION now warns
                                // (astubbs#255, U13); the firing does not change.
