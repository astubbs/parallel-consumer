 ...
 * module wrote. {@link PcDrivenStatefulProofTest} is what makes Kafka's own ambient readers run.
 * <p>
...
class PcDrivenStreamsProofTest extends PcDrivenProofSupport {
    ...
    /**
     * The control for this test rather than for the module: same harness, same patched classes, PC dispatch
