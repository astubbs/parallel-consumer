 ...
 * @see BacklogCatchUpBenchmarkTest the headline, which also explains why the first, deliberately isolating
 *      benchmark is not carried onto this stack
 */
@Slf4j
@Isolated
@Tag("performance")
class WorkloadMatrixBenchmarkTest extends StreamsBenchmarkHarness {
     ...
     * correct it still measured a multi-fold gain on the branch forest this suite was cut from. That refutation is the more interesting one, because this time the
