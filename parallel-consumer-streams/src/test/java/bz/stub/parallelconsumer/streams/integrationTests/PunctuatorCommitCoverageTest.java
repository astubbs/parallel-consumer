 ...
 * @see bz.stub.parallelconsumer.streams.PcTaskDispatcher#hasUncommittedWork()
 * @see bz.stub.parallelconsumer.streams.PcTaskDispatcher#onCommitSuccess(Map)
 */
@Slf4j
                        ...
                        new Processor<String, String, Void, Void>() {
                            ...
                            public void init(final ProcessorContext<Void, Void> context) {
                                if (withPunctuator) {
                                    ...
                                    // by the patch, so its FIRING is stock and only its commit bookkeeping
                                    // is in question - which is what this class measures. It used to be
                                    // the silent case as well; schedule() now warns about it at
                                    // registration, which is a separate change and not what is asserted
                                    // here.
