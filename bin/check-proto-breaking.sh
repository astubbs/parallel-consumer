...
# astubbs#242). The plan travels with the work it plans, on astubbs#293 -
# `git show origin/feats/proxy-requirements:docs/plans/2026-08-14-001-feat-language-proxy-plan.md`.
# What the freeze MEANS is owned by the banner at the top of the schema and by
# parallel-consumer-proxy-protocol/docs/protocol-specification.md, both of which are on master with
# this gate.
#
