...
// OWN run-to-run variance, which was measured at ~30% on one commit with its controls flat - that is a
// property of the test, not of the comparison, and no arithmetic here can touch it. It is why the
// reference is a MEDIAN over several runs and why the bounds are coarse.
