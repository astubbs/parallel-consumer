...
# policy for the generated clients is a separate document that arrives with the clients it governs, on
# astubbs#293 - `git show origin/feats/proxy-requirements:docs/client-static-analysis.md`.
#
