 ...
 *       DSL <em>solely</em> because this route inherits state stores for free, so a spike that never
 ...
 *       observed through Kafka's own store stack rather than through a probe this spike wrote.</li>
...
class PcDrivenStatefulProofTest extends PcDrivenProofSupport {
    ...
    private static final String COUNT_STORE = "pc-spike-counts";

    /**
     * The spike-side-only store whose changelog timestamp IS an ambient read - see the class javadoc. It has
     ...
     */
    private static final String PROBE_STORE = "pc-spike-probe-store";
