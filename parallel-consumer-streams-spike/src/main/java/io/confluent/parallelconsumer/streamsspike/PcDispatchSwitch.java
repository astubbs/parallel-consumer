 ...
 * {@code parallel-consumer-streams-spike} on their classpath by accident - it is a separate, loudly-labelled
 ...
 * <p>
 * The property is still how you turn it <b>off</b>: {@code -Dpc.streams.spike.dispatch.enabled=false} puts a
...
public final class PcDispatchSwitch {
    ...
    /**
     * Set {@code -Dpc.streams.spike.dispatch.enabled=false} to turn the seam off for a whole JVM and get stock
