...
public class KafkaStreamsEncodingNotSupported extends EncodingNotSupportedException{
    ...
    public KafkaStreamsEncodingNotSupported(String message) {
        super(message);
    }

    public KafkaStreamsEncodingNotSupported(String message, Throwable cause) {
        super(message, cause);
    }

    public KafkaStreamsEncodingNotSupported(Throwable cause) {
        super(cause);
    }
}
