...
import static io.confluent.parallelconsumer.AbstractParallelStreamProcessor.State.*;
...
public class AbstractParallelStreamProcessor<K, V> implements ParallelStreamProcessor<K, V>, ConsumerRebalanceListener, Closeable {
     ...
     */
    public AbstractParallelStreamProcessor(ParallelConsumerOptions newOptions) {
