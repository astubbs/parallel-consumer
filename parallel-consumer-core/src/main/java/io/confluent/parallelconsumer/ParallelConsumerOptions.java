...
public class ParallelConsumerOptions<K, V> {
    ...
    public enum CommitMode {
        /**
         * Periodically commits through the Producer using transactions. Slowest of the options, but no duplicates in Kafka
        ...
        /**
         * Periodically synchronous commits with the Consumer. Much faster than {@link #PERIODIC_TRANSACTIONAL_PRODUCER}. Slower but
         * potentially less duplicates than {@link #PERIODIC_CONSUMER_ASYNCHRONOUS} upon replay.
         */
        PERIODIC_CONSUMER_SYNC,
        /**
         * Periodically commits offsets asynchronously. The fastest option, under normal conditions will have few of no duplicates. Under failure revocery may have more
         * duplicates than {@link #PERIODIC_CONSUMER_SYNC}.
         */
