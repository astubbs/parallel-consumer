...
public enum PCMetricsDef {
    ...
    NAVIGATOR_CREDITS_OVERDRAFT("navigator.credits.overdraft", "Navigator (U4, KTD2) - cumulative debits taken against this tagged resource when no live credit remained (KTD1's always-succeeds rule, KD10) - bounded by the resource's declared burst under R8's overshoot bound", PCMetricsSubsystem.NAVIGATOR, GAUGE, tag("resource", "resourceName")),
