...
import static bz.stub.parallelconsumer.State.*;
...
public class BrokerPollSystem<K, V> implements OffsetCommitter {
     ...
     * {@link bz.stub.parallelconsumer.PCHealth#getPollerState()}, not directly.
     */
    ...
    /**
     * While {@link bz.stub.parallelconsumer.State#PAUSED paused} is an externally controlled state that
     ...
     * {@link bz.stub.parallelconsumer.State#RUNNING running}, calling this method will be a no-op.
     * </p>
     */
     ...
     * <p>
     * Note: If the poll system is currently not in state
     * {@link bz.stub.parallelconsumer.State#PAUSED paused}, calling this method will be a no-op.
     * </p>
     */
