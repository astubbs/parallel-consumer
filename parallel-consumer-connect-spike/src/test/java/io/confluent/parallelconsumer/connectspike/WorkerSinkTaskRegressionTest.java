...
class WorkerSinkTaskRegressionTest {
    ...
    private static final String BRIDGE = "io.confluent.parallelconsumer.connectspike.PcConnectDispatchBridge";
    ...
    void regressionArmLoadsItsIntendedIsolatedClasspath() throws Exception {
        ...
        assertThat(workerLocation.toString())
                .doesNotContain(".jar")
                .contains("/parallel-consumer-connect-spike/target/classes/");
