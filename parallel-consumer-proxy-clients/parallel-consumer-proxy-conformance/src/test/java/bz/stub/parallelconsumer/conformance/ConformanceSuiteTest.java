 ...
 * is how ten clients end up with ten slightly different definitions of the same scenario. A binding appears
 * here by being registered - {@link JvmClientBindings} today, the foreign runners' registry when extraction
 * A9 brings it; nothing else about this file changes when the next one arrives.
 * <p>
